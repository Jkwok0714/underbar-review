  ...
  describe('Part I', function() {
    ...
    describe('each', function() {
      ...
      it('should not mutate the input array', function() {
         ...
         *
         * var lastElement = input[input.length - 1];hmvk
         *
    ...
    describe('uniq', function() {
      ...
      it('should handle iterators that work with a sorted array', function() {
        var iterator = function(value) { return value === 1; }; // Turns all of numbers arr into true or false.
        var numbers = [1, 2, 2, 3, 4, 4]; //[true, false, false....., false];

        expect(_.uniq(numbers, true, iterator)).to.eql([1, 2]); // [true, false] => [1, 2]
      });
    ...
    describe('reduce', function() {
      ...
      it('should reduce all elements based on accumulator to a single value', function() {
        var result = _.reduce([1, 2, 3], function(memo, item) {
          return memo * item;
        }, 0);
